...
I solve it by searching solution nodes in a tree generated by a mini rule-based system.

My tree is a finite tree, so when there is no solution node in the tree, we conclude there is no solution.

By the properties of the problem, usually there are 2 solutions in 2 containers or no solution.
